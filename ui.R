           ...
           navbarPage("", id = "navBar", selected = "Home",
                      ...
                      tabPanel("Layer Selection & Layouts",
                              ...
                              selectInput("selectLayout", "Apply Layout Algorithm on Selected Layers:", c("-", "Reingold-Tilford", "Circle", "Grid", "Random", "Davidson-Harel", "DrL", 
                                                                                                           ...
                                                                                                           "Multidimensional Scaling", "Sugiyama"),width = '500px'),
                              selectInput("selectCluster", "Apply Clustering on Selected Layers (Not necessary):", c("-", "Louvain", "Walktrap", "Edge Betweenness", "Fast Greedy", "Label Propagation"),width = '500px'),
                              selectInput("selectLocalLayout", "Apply Local Layout Algorithm:", c("-", "Reingold-Tilford", "Circle", "Grid", "Random", "Davidson-Harel", "DrL", 
                                                                                                           "Fruchterman-Reingold", "GEM", "Graphopt", "Kamada-Kawai", "Large Graph Layout",
                                                                                                           "Multidimensional Scaling", "Sugiyama"),width = '500px'),
                      ...
                      tabPanel("Edge Actions",
                                ...
                                checkboxInput("edgeWidthByWeight", "Edge Opacity By Weight", value = F, width = NULL),
